...
static RXTXTypeDef *TMC2209_UARTChannel;
...
void tmc2209_writeRegister(u8 motor, uint8 address, int32 value)
{
	UNUSED(motor);
	UART_writeInt(TMC2209_UARTChannel, tmc2209_get_slave(&TMC2209), address, value);
}

void tmc2209_readRegister(u8 motor, uint8 address, int32 *value)
{
	UNUSED(motor);
