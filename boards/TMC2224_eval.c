...
void tmc2224_writeConfiguration()
{
    ...
    {
        settings = *(tmc2224_shadowRegister + 0);
...
static uint8_t reset()
{
    ...
    {
        tmc2224_setDirtyBit(DEFAULT_ICID, i, false);
