...
static inline TMC4361ATypeDef *motorToIC(uint8 motor)
{
	UNUSED(motor);
...
// => SPI Wrapper
void tmc4361A_readWriteArray(uint8 channel, uint8 *data, size_t length)
{
...
static void tmc4361A_fullCover(uint8 *data, size_t length)
{
