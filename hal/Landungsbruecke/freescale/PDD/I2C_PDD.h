...
#define I2C_PDD_SetSlaveAddress7bits(PeripheralBase, AddrValue) ( \
    (I2C_A1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_A1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_A1_AD_MASK))) | ( \
      (uint8)((uint8)(AddrValue) << I2C_A1_AD_SHIFT)))), \
    (I2C_C2_REG(PeripheralBase) &= \
     (uint8)(~(uint8)I2C_C2_ADEXT_MASK)) \
  )
...
#define I2C_PDD_SetSlaveAddress10bits(PeripheralBase, AddrValue) ( \
    (I2C_A1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_A1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_A1_AD_MASK))) | ( \
      (uint8)((uint8)((uint16)(AddrValue) & 0x7FU) << I2C_A1_AD_SHIFT)))), \
    (I2C_C2_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C2_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C2_AD_MASK))) | (( \
      (uint8)((uint16)(AddrValue) >> 7U)) | ( \
      I2C_C2_ADEXT_MASK)))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadAddress1Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_SetFrequencyDivider(PeripheralBase, FreqDividerValue) ( \
    I2C_F_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_F_REG(PeripheralBase) & (uint8)(~(uint8)I2C_F_ICR_MASK))) | ( \
      (uint8)(FreqDividerValue))) \
  )
...
#define I2C_PDD_SetFrequencyMultiplier(PeripheralBase, FreqMultiplierValue) ( \
    I2C_F_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_F_REG(PeripheralBase) & (uint8)(~(uint8)I2C_F_MULT_MASK))) | ( \
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadFrequencyDividerReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_EnableDevice(PeripheralBase, State) ( \
    I2C_C1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C1_IICEN_MASK))) | ( \
      (uint8)((uint8)(State) << I2C_C1_IICEN_SHIFT))) \
  )
...
#define I2C_PDD_SetMasterMode(PeripheralBase, MasterMode) ( \
    I2C_C1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C1_MST_MASK))) | ( \
      (uint8)(MasterMode))) \
  )
 ...
 *         GetMasterMode macros)." type. The value is cast to "uint8".
 * @remarks The macro accesses the following registers: I2C0_C1, I2C1_C1,
 *          I2C2_C1, I2C3_C1 (depending on the peripheral).
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_GetMasterMode(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define I2C_PDD_GetMasterMode(PeripheralBase) ( \
    (uint8)(I2C_C1_REG(PeripheralBase) & I2C_C1_MST_MASK) \
  )
...
#define I2C_PDD_SetTransmitMode(PeripheralBase, TransmitMode) ( \
    I2C_C1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C1_TX_MASK))) | ( \
      (uint8)(TransmitMode))) \
  )
 ...
 *         GetTransmitMode macros)." type. The value is cast to "uint8".
 * @remarks The macro accesses the following registers: I2C0_C1, I2C1_C1,
 *          I2C2_C1, I2C3_C1 (depending on the peripheral).
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_GetTransmitMode(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define I2C_PDD_GetTransmitMode(PeripheralBase) ( \
    (uint8)(I2C_C1_REG(PeripheralBase) & I2C_C1_TX_MASK) \
  )
...
#define I2C_PDD_EnableWakeUp(PeripheralBase, State) ( \
    I2C_C1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C1_WUEN_MASK))) | ( \
      (uint8)((uint8)(State) << I2C_C1_WUEN_SHIFT))) \
  )
...
#define I2C_PDD_EnableDmaRequest(PeripheralBase, State) ( \
    I2C_C1_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C1_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C1_DMAEN_MASK))) | ( \
      (uint8)(State))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadControl1Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadStatusReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 *         type. The value is cast to "uint8".
 * @remarks The macro accesses the following registers: I2C0_S, I2C1_S, I2C2_S,
 *          I2C0_S1, I2C1_S1, I2C3_S (depending on the peripheral).
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_GetBusStatus(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define I2C_PDD_GetBusStatus(PeripheralBase) ( \
    (uint8)(I2C_S_REG(PeripheralBase) & I2C_S_BUSY_MASK) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_GetInterruptFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_ClearInterruptFlags(PeripheralBase, Mask) ( \
    I2C_S_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_S_REG(PeripheralBase)) & ( \
       (uint8)(~(uint8)(I2C_S_IICIF_MASK | I2C_S_ARBL_MASK))))) | ( \
      (uint8)(Mask))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadDataReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_EnableGeneralCallAddress(PeripheralBase, State) ( \
    I2C_C2_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C2_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C2_GCAEN_MASK))) | ( \
      (uint8)((uint8)(State) << I2C_C2_GCAEN_SHIFT))) \
  )
...
#define I2C_PDD_EnableAddressExtension(PeripheralBase, State) ( \
    I2C_C2_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C2_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C2_ADEXT_MASK))) | ( \
      (uint8)((uint8)(State) << I2C_C2_ADEXT_SHIFT))) \
  )
...
#define I2C_PDD_EnableRangeAddressMatch(PeripheralBase, State) ( \
    I2C_C2_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_C2_REG(PeripheralBase) & (uint8)(~(uint8)I2C_C2_RMEN_MASK))) | ( \
      (uint8)((uint8)(State) << I2C_C2_RMEN_SHIFT))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadControl2Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
  ...
  #define I2C_PDD_SetInputGlitchFilter(PeripheralBase, FilterFactorValue) ( \
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(( \
         I2C_FLT_REG(PeripheralBase)) & (( \
         (uint8)(~(uint8)I2C_FLT_FLT_MASK)) & ( \
         (uint8)(~(uint8)I2C_FLT_STOPF_MASK))))) | ( \
        (uint8)(FilterFactorValue))) \
    )
      ...
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(( \
         I2C_FLT_REG(PeripheralBase)) & (( \
         (uint8)(~(uint8)I2C_FLT_FLT_MASK)) & (( \
         (uint8)(~(uint8)I2C_FLT_STARTF_MASK)) & ( \
         (uint8)(~(uint8)I2C_FLT_STOPF_MASK)))))) | ( \
        (uint8)(FilterFactorValue))) \
    )
 ...
 */
  #define I2C_PDD_SetInputGlitchFilter(PeripheralBase, FilterFactorValue) ( \
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(I2C_FLT_REG(PeripheralBase) & (uint8)(~(uint8)I2C_FLT_FLT_MASK))) | ( \
        (uint8)(FilterFactorValue))) \
    )
...
#define I2C_PDD_SetRangeAddress(PeripheralBase, RangeAddressValue) ( \
    I2C_RA_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_RA_REG(PeripheralBase) & (uint8)(~(uint8)I2C_RA_RAD_MASK))) | ( \
      (uint8)((uint8)(RangeAddressValue) << I2C_RA_RAD_SHIFT))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadRangeAddressReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_EnableFastSmBusNackAck(PeripheralBase, State) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_SMB_REG(PeripheralBase)) & (( \
       (uint8)(~(uint8)I2C_SMB_FACK_MASK)) & (( \
       (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
       (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))))) | ( \
      (uint8)((uint8)(State) << I2C_SMB_FACK_SHIFT))) \
  )
 ...
 *         GetFastSmBusAcknowledge macro)." type. The value is cast to "uint8".
 * @remarks The macro accesses the following registers: I2C0_SMB, I2C1_SMB,
 *          I2C2_SMB, I2C3_SMB (depending on the peripheral).
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_GetFastSmBusAcknowledge(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define I2C_PDD_GetFastSmBusAcknowledge(PeripheralBase) ( \
    (uint8)(I2C_SMB_REG(PeripheralBase) & I2C_SMB_FACK_MASK) \
  )
...
#define I2C_PDD_EnableSmBusAlertResponseAddress(PeripheralBase, State) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_SMB_REG(PeripheralBase)) & (( \
       (uint8)(~(uint8)I2C_SMB_ALERTEN_MASK)) & (( \
       (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
       (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))))) | ( \
      (uint8)((uint8)(State) << I2C_SMB_ALERTEN_SHIFT))) \
  )
...
#define I2C_PDD_EnableSecondI2CAddress(PeripheralBase, State) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_SMB_REG(PeripheralBase)) & (( \
       (uint8)(~(uint8)I2C_SMB_SIICAEN_MASK)) & (( \
       (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
       (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))))) | ( \
      (uint8)((uint8)(State) << I2C_SMB_SIICAEN_SHIFT))) \
  )
...
#define I2C_PDD_SetSCLTimeoutBusClockSource(PeripheralBase, ClockSource) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_SMB_REG(PeripheralBase)) & (( \
       (uint8)(~(uint8)I2C_SMB_TCKSEL_MASK)) & (( \
       (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
       (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))))) | ( \
      (uint8)(ClockSource))) \
  )
...
#define I2C_PDD_GetSCLTimeoutInterruptFlags(PeripheralBase) ( \
    (uint8)(( \
     I2C_SMB_REG(PeripheralBase)) & ( \
     (uint8)(I2C_SMB_SLTF_MASK | (I2C_SMB_SHTF1_MASK | I2C_SMB_SHTF2_MASK)))) \
  )
...
#define I2C_PDD_ClearSCLTimeoutInterruptFlags(PeripheralBase, Mask) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(( \
       I2C_SMB_REG(PeripheralBase)) & ( \
       (uint8)(~(uint8)(I2C_SMB_SLTF_MASK | I2C_SMB_SHTF2_MASK))))) | ( \
      (uint8)(Mask))) \
  )
...
#define I2C_PDD_EnableSCLTimeoutInterrupt(PeripheralBase) ( \
    I2C_SMB_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_SMB_REG(PeripheralBase) | I2C_SMB_SHTF2IE_MASK)) & (( \
      (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
      (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))) \
  )
...
#define I2C_PDD_DisableSCLTimeoutInterrupt(PeripheralBase) ( \
    I2C_SMB_REG(PeripheralBase) &= \
     (uint8)(( \
      (uint8)(~(uint8)I2C_SMB_SHTF2IE_MASK)) & (( \
      (uint8)(~(uint8)I2C_SMB_SHTF2_MASK)) & ( \
      (uint8)(~(uint8)I2C_SMB_SLTF_MASK)))) \
  )
...
#define I2C_PDD_SetSMBusSlaveAddress(PeripheralBase, SMBusSlaveAddrValue) ( \
    I2C_A2_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_A2_REG(PeripheralBase) & (uint8)(~(uint8)I2C_A2_SAD_MASK))) | ( \
      (uint8)((uint8)(SMBusSlaveAddrValue) << I2C_A2_SAD_SHIFT))) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadAddress2Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
...
#define I2C_PDD_SetSCLLowTimeout(PeripheralBase, SCLLowTimeoutValue) ( \
    (I2C_SLTL_REG(PeripheralBase) = \
     (uint8)(SCLLowTimeoutValue)), \
    (I2C_SLTH_REG(PeripheralBase) = \
     (uint8)((uint16)(SCLLowTimeoutValue) >> 8U)) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadSclLowTimeoutLowReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
  ...
  #define I2C_PDD_EnableStopHoldOffMode(PeripheralBase, State) ( \
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(( \
         I2C_FLT_REG(PeripheralBase)) & (( \
         (uint8)(~(uint8)I2C_FLT_SHEN_MASK)) & ( \
         (uint8)(~(uint8)I2C_FLT_STOPF_MASK))))) | ( \
        (uint8)((uint8)(State) << I2C_FLT_SHEN_SHIFT))) \
    )
#else /* (defined(MCU_MK21F12)) || (defined(MCU_MK21F12WS)) || (defined(MCU_MK22F12)) || (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK22F51212)) || (defined(MCU_MK24F12)) || (defined(MCU_MK63F12)) || (defined(MCU_MK63F12WS)) || (defined(MCU_MK64F12)) || (defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKE02Z2)) || (defined(MCU_MKE02Z4)) || (defined(MCU_MKE04Z1284)) || (defined(MCU_MKE04Z4)) || (defined(MCU_MKE06Z4)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV31F51212)) || (defined(MCU_SKEAZ1284)) || (defined(MCU_SKEAZN642)) || (defined(MCU_SKEAZN84)) */
/**
 * @brief Enables/disables stop mode holdoff.
 ...
 * @par Example:
 *      @code
 *      uint8 result = I2C_PDD_ReadBusStatusFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 */
  #define I2C_PDD_ClearBusStatusInterruptFlags(PeripheralBase, Mask) ( \
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(I2C_FLT_REG(PeripheralBase) & (uint8)(~(uint8)I2C_FLT_STOPF_MASK))) | ( \
        (uint8)(Mask))) \
    )
#else /* (defined(MCU_MK21F12)) || (defined(MCU_MK21F12WS)) || (defined(MCU_MK22F12)) || (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK22F51212)) || (defined(MCU_MK24F12)) || (defined(MCU_MK63F12)) || (defined(MCU_MK63F12WS)) || (defined(MCU_MK64F12)) || (defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKE02Z2)) || (defined(MCU_MKE02Z4)) || (defined(MCU_MKE04Z1284)) || (defined(MCU_MKE04Z4)) || (defined(MCU_MKE06Z4)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV31F51212)) || (defined(MCU_SKEAZ1284)) || (defined(MCU_SKEAZN642)) || (defined(MCU_SKEAZN84)) */
/**
  ...
  #define I2C_PDD_ClearBusStatusInterruptFlags(PeripheralBase, Mask) ( \
      I2C_FLT_REG(PeripheralBase) = \
       (uint8)(( \
        (uint8)(( \
         I2C_FLT_REG(PeripheralBase)) & ( \
         (uint8)(~(uint8)(I2C_FLT_STOPF_MASK | I2C_FLT_STARTF_MASK))))) | ( \
        (uint8)(Mask))) \
    )
#endif /* (defined(MCU_MK21F12)) || (defined(MCU_MK21F12WS)) || (defined(MCU_MK22F12)) || (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK22F51212)) || (defined(MCU_MK24F12)) || (defined(MCU_MK63F12)) || (defined(MCU_MK63F12WS)) || (defined(MCU_MK64F12)) || (defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKE02Z2)) || (defined(MCU_MKE02Z4)) || (defined(MCU_MKE04Z1284)) || (defined(MCU_MKE04Z4)) || (defined(MCU_MKE06Z4)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV31F51212)) || (defined(MCU_SKEAZ1284)) || (defined(MCU_SKEAZN642)) || (defined(MCU_SKEAZN84)) */
...
#define I2C_PDD_EnableBusStopOrStartInterrupt(PeripheralBase) ( \
    I2C_FLT_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_FLT_REG(PeripheralBase) | I2C_FLT_SSIE_MASK)) & (( \
      (uint8)(~(uint8)I2C_FLT_STARTF_MASK)) & ( \
      (uint8)(~(uint8)I2C_FLT_STOPF_MASK)))) \
  )
...
#define I2C_PDD_EnableBusStopInterrupt(PeripheralBase) ( \
    I2C_FLT_REG(PeripheralBase) = \
     (uint8)(( \
      (uint8)(I2C_FLT_REG(PeripheralBase) | I2C_FLT_STOPIE_MASK)) & ( \
      (uint8)(~(uint8)I2C_FLT_STOPF_MASK))) \
  )
...
#define I2C_PDD_DisableBusStopInterrupt(PeripheralBase) ( \
    I2C_FLT_REG(PeripheralBase) &= \
     (uint8)(( \
      (uint8)(~(uint8)I2C_FLT_STOPIE_MASK)) & ( \
      (uint8)(~(uint8)I2C_FLT_STOPF_MASK))) \
  )
