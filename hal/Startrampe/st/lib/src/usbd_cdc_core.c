...
__ALIGN_BEGIN uint8_t USB_Rx_Buffer   [CDC_DATA_MAX_PACKET_SIZE] __ALIGN_END ;
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN int8_t APP_Rx_Buffer   [APP_RX_DATA_SIZE] __ALIGN_END ;
                                ...
                                USB_SETUP_REQ *req)
{
  ...
  case USB_REQ_TYPE_STANDARD:
    ...
    case USB_REQ_GET_INTERFACE :
      // Avoid compiler warning about discarding volatile here by casting to unsigned long first
      USBD_CtlSendData (pdev, (uint8_t *)(unsigned long) &usbd_cdc_AltSet, 1);
      break;
